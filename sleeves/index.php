...
<html>
  <head>
    <title>Dan Benson Racing - Benson Signature Series Block Sleeves</title>
<?php  
...
?> 
      <section class="content">
		 <sidebar>
		 	<div class="sidebar-content">
			 	...
			 	<div class="widget textbox">
					<p>Dan Benson has moved his shop from California to Idaho.<br />
				</div><!--end widget-->
				
				<div class="widget address">
					<p><strong>Call for pricing!</strong></p>
					<p><strong>208-946-6298</strong></p>
        ...
        <section class="main-content">
          ...
          </h3><img src="../images/sleeve.jpg" class="inline-photo" alt="Image" />
          <p>
          ...
          </p><img src="../images/bensons.jpg" class="inline-photo" alt="Image" />
          <p>
          ...
          <div class="product">
            <h5>
              EJ 25 Subaru
            </h5><img src="../images/image1.jpg" alt="Image" />
          </div><!--end product-->
          <div class="product">
            <h5>
              EJ 25 Subaru
            </h5><img src="../images/image2.jpg" alt="Image" />
          </div><!--end product-->
          <div class="product">
            <h5>
              LS-1 being converted to a LS-7 427
            </h5><img src="../images/image3.jpg" alt="Image" />
          </div><!--end product-->
          <div class="product">
            <h5>
              Small block Chevrolet being machined
            </h5><img src="../images/image4.jpg" alt="Image" />
          </div><!--end product-->
          <div class="product">
            <h5>
              Finished Honda block after sleeving
            </h5><img src="../images/image5.jpg" alt="Image" />
          </div><!--end product-->
